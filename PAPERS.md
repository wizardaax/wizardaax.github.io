...
- **[Cross-domain constants — the framework's strongest empirical claim](./findings/cross_domain_constants_2026_05.md)** (2026-05-02, meta-finding). φ, golden_angle (137.508°), α⁻¹ (137.036), ψ (144) appear in BOTH the Riemann · φ clustering test AND the AEON gravity-flyer simulation as **derivations, not free parameters**. Two unrelated physics regimes producing falsifiable results from one constant table is harder to reach by accident than either result alone.
